...
Öffnen Sie [LDR](https://app.ldr-design.com) und holen Sie sich 5 kostenlose Credits (danach eine kostenlose Generierung pro Tag — **Credits verfallen nie**). Nehmen Sie eines Ihrer eigenen Tagfotos. Generieren Sie einmal ohne jede Markierung, markieren Sie dann die Leuchtenpositionen und generieren Sie erneut. Legen Sie beide nebeneinander und schauen Sie, wo das Licht landet.
