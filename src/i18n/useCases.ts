...
> = {
  ...
  zh: {
    "architectural-lighting": {
      ...
      metaDesc:
        "在灯具安装前先看到建筑照明设计效果：上传建筑白天照片，用 AI 生成专业夜景效果图，验证立面上照、屋顶线条与入口雨篷的照明方案，无需三维模型。",
      intro: [
    ...
    "landscape-lighting": {
      ...
      metaDesc:
        "用 AI 白天转夜景渲染预览景观照明设计：上传白天照片即可看到花园、公园与户外空间在夜间灯光下的真实效果，便于甲方与规划评审确认方案取舍与色温选择。",
      intro: [
    ...
    "urban-night-planning": {
      ...
      metaDesc:
        "用 AI 可视化推进城市夜景规划：把街景与航拍白天照片转为写实夜景效果图，在实施前评估照明策略，可用于公众参与、规划委员会汇报与国际设计竞赛提案。",
      intro: [
    ...
    "hospitality-lighting": {
      ...
      metaDesc:
        "在施工前可视化酒店照明设计：把酒店、度假村与餐厅的白天照片用 AI 转成夜景效果图，比对色温方案与灯具位置之后再确定选型，加快业主与运营方确认。",
      intro: [
  ...
  ja: {
    "architectural-lighting": {
      ...
      metaDesc:
        "器具を設置する前に建築照明デザインを確認。建物の昼間の写真を AI で夜景パースに変換し、ファサードのアッパーライトや屋根まわり、エントランスの照明計画を検証できます。",
      intro: [
    ...
    "landscape-lighting": {
      ...
      metaDesc:
        "AI の昼夜変換レンダリングでランドスケープ照明を事前確認。庭園・公園・住宅外構の昼間の写真から、園路や樹木、水景が夜にどう見えるかを可視化します。",
      intro: [
    ...
    "urban-night-planning": {
      ...
      metaDesc:
        "AI 可視化で都市夜景計画を検討。街路や俯瞰の昼間写真を夜景パースに変え、実施前に照明戦略を検証して、住民説明会や都市計画審議会の資料としても使えます。",
      intro: [
    ...
    "hospitality-lighting": {
      ...
      metaDesc:
        "施工前にホスピタリティ照明を可視化。ホテル・リゾート・レストランの昼間の写真を AI で夜景パースに変換し、色温度の比較や器具位置の確認を進められます。",
      intro: [
  ...
  ko: {
    "architectural-lighting": {
      ...
      metaDesc:
        "등기구를 설치하기 전에 건축조명 계획을 확인합니다. 건물의 낮 사진을 AI로 야경 렌더링으로 바꿔 파사드 업라이팅과 지붕선, 입구 캐노피 조명 구성을 검토합니다.",
      intro: [
    ...
    "landscape-lighting": {
      ...
      metaDesc:
        "AI 낮밤 변환 렌더링으로 조경조명 계획을 미리 확인합니다. 정원과 공원, 주거단지 외부 공간의 낮 사진에서 보행로와 수목, 수경시설의 밤 모습을 시각화합니다.",
      intro: [
    ...
    "urban-night-planning": {
      ...
      metaDesc:
        "AI 시각화로 야간경관 계획을 검토합니다. 가로와 항공 사진을 낮에서 밤으로 바꿔 시행 전에 조명 전략을 점검하고 주민설명회와 도시계획 심의 자료로 활용합니다.",
      intro: [
    ...
    "hospitality-lighting": {
      ...
      metaDesc:
        "시공 전에 호스피탈리티 조명을 시각화합니다. 호텔과 리조트, 레스토랑의 낮 사진을 AI로 야경 렌더링으로 바꿔 색온도 비교와 등기구 위치 검토를 진행합니다.",
      intro: [
